...
Функция daСклонение(_Выражение, _Падеж = "И", _Род = "", _Режим = "ФИО", _ФорматнаяСтрока = "") Экспорт
    ...
    ИначеЕсли _Параметр0 = "_ПросклонятьСлово" Тогда
        ...
        _ТаблицаПравила = daВычислить("_Правила" + _СтрокаСлово.Субметод, _ПравилаФ, _ПравилаИ, _ПравилаО, _ПравилаД, _ПравилаЧ, _ПравилаВ);
    ...
    Пока _ПозЧастиСтроки <= _МассивЧастиСтроки.ВГраница() Цикл
        ...
        Иначе
		    ...
		    Если _Метод = "Ч" И _СтрокаСлово.Склонение <> "-" И _СтрокаСлово.Склонение <> "+" И _СтруктураТипы.ЕстьЦифры И НЕ _СтруктураТипы.ЕстьНеЦифры Тогда 
                ...
                _МассивЧастиСубСтроки = daСклонение("_ВМассивСРазделителями", СокрЛП(daЧислоПрописью(_ЧастьСтроки)), " ");
...
Функция daВычислить(ВычисляемоеПравило, _ПравилаФ, _ПравилаИ, _ПравилаО, _ПравилаД, _ПравилаЧ, _ПравилаВ)
	
	_ТаблицаПравила = "";
	
	Если ВычисляемоеПравило = "_ПравилаФ" Тогда
		_ТаблицаПравила = _ПравилаФ;
	ИначеЕсли ВычисляемоеПравило = "_ПравилаИ" Тогда
		_ТаблицаПравила = _ПравилаИ;
	ИначеЕсли ВычисляемоеПравило = "_ПравилаО" Тогда
		_ТаблицаПравила = _ПравилаО;
	ИначеЕсли ВычисляемоеПравило = "_ПравилаД" Тогда
		_ТаблицаПравила = _ПравилаД;
	ИначеЕсли ВычисляемоеПравило = "_ПравилаЧ" Тогда
		_ТаблицаПравила = _ПравилаЧ;
	ИначеЕсли ВычисляемоеПравило = "_ПравилаВ" Тогда
		_ТаблицаПравила = _ПравилаВ;
	КонецЕсли;
	
	Возврат _ТаблицаПравила;
	
КонецФункции

//функция получения числа прописью  
Функция daЧислоПрописью(ЧислоП) 
    ...
    ЧислоППрописью = СтрШаблон("%1%2", Врег(Сред(ЧислоППрописью, 1, 1)), Сред(ЧислоППрописью, 2));
